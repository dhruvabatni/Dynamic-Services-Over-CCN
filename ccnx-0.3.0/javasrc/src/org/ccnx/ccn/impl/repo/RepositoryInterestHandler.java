	...
	public boolean handleInterest(Interest interest) {
		...
		try {
			if (RepositoryOperations.isStartWriteOperation(interest)) {
				...
				content = _server.getRepository().getContent(interest);
                if (_server.getRepository().hasContent(ContentName.fromURI(interest.name().toURIString())) == true) {
                    System.out.println("TRUE URI = " + ContentName.fromURI(interest.name().toURIString()));
                } else {
                    System.out.println("FALSE URI = " + ContentName.fromURI(interest.name().toURIString()));
                }
				content = _server.getRepository().getContent(interest);
				if (content != null) {
				    //System.out.println("Satisfying interest hurray: "+ interest + "||" + " Content = " + content.name() );
				    ...
				    System.out.println("not satisfying interest: "+ interest);
